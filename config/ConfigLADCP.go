...
func GetConfigLADCP(nc *lib.Nc,m *Map,cfg toml.Configtoml,configFile string,Type string,optAll *bool) {
	...
	nc.Attributes["data_type"] = Type
		...
		nc.Attributes["type_instrument"] = cfg.Ladcp.TypeInstrument
		nc.Attributes["instrument_number"] = cfg.Ladcp.InstrumentNumber
